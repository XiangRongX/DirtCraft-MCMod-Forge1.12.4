...
public class DirtGolemHeadLayer extends RenderLayer<DirtGolemRenderState, DirtGolemModel> {
    private final BlockRenderDispatcher blockRenderer;

    public DirtGolemHeadLayer(RenderLayerParent<DirtGolemRenderState, DirtGolemModel> pRenderer, BlockRenderDispatcher pBlockRenderer) {
        super(pRenderer);
        this.blockRenderer = pBlockRenderer;
    }

    public void render(PoseStack p_117483_, MultiBufferSource p_117484_, int p_117485_, DirtGolemRenderState p_376455_, float p_117487_, float p_117488_) {
