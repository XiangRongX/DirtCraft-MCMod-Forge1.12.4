...
public class DirtGolemModel extends EntityModel<LivingEntityRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(TestMod.MODID, "dirt_golem"), "main");
    ...
    public DirtGolemModel(ModelPart pRoot) {
        super(pRoot);
